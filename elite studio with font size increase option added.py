 ...
 * A+     : 1.18
 *
 * The scale is limited to readable text and controls. The logo
 * itself is intentionally not scaled.
 */
...
.elite-fast-intro-title {
    font-size:calc(15px * var(--elite-font-scale));
}


.elite-fast-intro-sub {
    font-size:calc(12px * var(--elite-font-scale));
}


.elite-fast-demo {
    font-size:calc(10.5px * var(--elite-font-scale));
}


.progress-top {
    font-size:calc(11px * var(--elite-font-scale));
}


.progress-status {
    font-size:calc(10px * var(--elite-font-scale));
}


.chat-bubble {
    font-size:calc(14px * var(--elite-font-scale));
}


.chat-time {
    font-size:calc(8px * var(--elite-font-scale));
}


.input-title {
    font-size:calc(13px * var(--elite-font-scale));
}
...
@media (max-width:650px) {
    ...
    .chat-bubble {
        max-width:90%;
        font-size:calc(12.5px * var(--elite-font-scale));
    }
...
>
    ...
    >
        ...
        <button
            ...
            id="sound-toggle"
            type="button"
            aria-label="Turn assistant sound off"
            title="Assistant sound"
        >
            🔊
        </button>
...
(function(){{
    ...
    soundButton.addEventListener(
        ...
        function(){{
            ...
            soundButton.setAttribute(
                'aria-label',
                soundEnabled
                ? 'Turn assistant sound off'
                : 'Turn assistant sound on'
            );
    ...
    function updateFontButtons(){{
        ...
        fontDecrease.classList.toggle(
            'active',
            fontScale === FONT_SCALES.small
        );


        fontNormal.classList.toggle(
            'active',
            fontScale === FONT_SCALES.normal
        );


        fontIncrease.classList.toggle(
            'active',
    ...
    function applyFontScale(
        ...
        /*
         * Use a root-level CSS variable so every text rule that
         * participates in the customer UI can scale consistently.
         *
         * The CSS below uses this variable through the helper
         * overrides added to FRONTEND_CSS.
         */
        ...
        /*
         * Keep the customer's position inside the conversation.
         * Changing font size must not unexpectedly jump the chat.
         */
    ...
    /*
     * Restore customer preferences when available.
     * Defaults are intentionally normal size + sound on.
     */
    try {{
    ...
    function boot(){{
         ...
         * No page-level scrolling is performed after this point.
         */
